...
const AboutSection = () => {
  ...
  return <section className="section bg-texture">
      <div className="container-custom">
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          {/* Image */}
          <div className="relative">
            <div className="relative overflow-hidden rounded-lg shadow-lg md:ml-12 border border-gray-700">
              <img src="/img/bs1.jpg" alt="Наша команда мастеров" className="h-full w-full object-cover" />
            </div>
            <div className="absolute -bottom-6 -left-6 hidden h-64 w-64 rounded-lg md:block" style={{
          ...
          <div>
            ...
            <h2 className="mb-4 text-3xl font-bold sm:text-4xl">Самые красивые шатры с 2020 г</h2>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              {values.map((value, index) => <div key={index} className="flex items-start">
